...
export default function QuizAnalyticsDashboard() {
  ...
  useEffect(() => {
    // Keep in sync with quiz submissions
  ...
  // Unique list of quizzes present in attempts for the filter dropdown
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-3.5 rounded-2xl border border-gray-200/80 shadow-2xs">
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="rounded-xl border border-gray-200 bg-gray-50/50 px-3 py-1.5 text-xs font-medium text-gray-800 focus:bg-white focus:outline-hidden focus:ring-2 focus:ring-emerald-500/20 cursor-pointer"
          >
            <option value="ALL">All Assessments ({attempts.length} records)</option>
      ...
      {/* Top 4 KPI Cards matching Reference Screenshot (calculated dynamically) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-xs transition-all hover:shadow-sm">
          ...
          <p className="mt-2 text-xs font-semibold text-emerald-700 flex items-center gap-1">
            ...
            {summary.uniqueStudents} unique students
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 rounded-2xl border border-gray-200 bg-white p-6 shadow-xs">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b border-gray-100">
            <div>
              ...
              <p className="text-xs text-gray-500">Cohort percentiles across weeks (W1–W8)</p>
            </div>
            {/* Chart Legend */}
          ...
          <div className="mt-6 mb-2 relative">
            ...
            >
              <defs>
                {/* Gradient for Average Fill */}
                <linearGradient id="avgGrad" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#f97316" stopOpacity="0.25" />
                  <stop offset="100%" stopColor="#f97316" stopOpacity="0.02" />
                </linearGradient>
                {/* Gradient for Top Fill */}
        ...
        {/* Right Col: Highest Error-Rate Topics (calculated dynamically) */}
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-xs flex flex-col justify-between">
          <div>
            <div className="pb-2 border-b border-gray-100 mb-4">
              ...
              <p className="text-xs text-gray-500">Topics with lowest correct answers</p>
            </div>
          ...
          <div className="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between text-[11px] text-gray-400">
            <span>Aggregated from questions missed</span>
            <span className="font-medium text-gray-500">Real-time stats</span>
          </div>
        </div>
      </div>

      {/* Bottom: Recent Student Results Table (Dynamically Populated from Database) */}
